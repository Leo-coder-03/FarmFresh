...
const Cart = () => {
    const {products,currency,cartItems,removeFromCart,getCartCount,updateCartItem,navigate,getCartAmount,axios,user,setCartItems
    } = useAppContext()
    ...
    const getUserAddress = async () =>{
        ...
        console.log(userId);
        try{
            const {data} = await axios.get('/api/address/get',{ params: { userId } , withCredentials: true});
            if(data.success){
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary hover:bg-primary-dull text-white font-medium transition">
