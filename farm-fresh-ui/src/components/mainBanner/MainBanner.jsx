...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      <h1 className="animated-heading text-3xl md:text-3xl lg:text-5xl font-bold text-center md:text-left max-w-74 md:max-w-74 lg:max-w-115 leading-tight lg:leading-15">
